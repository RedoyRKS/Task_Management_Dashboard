...
<aside className="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="index3.html" className="brand-link">
    <img src="dist/img/brandkiln_logo.jpg" alt="brandkiln Logo" className="brand-image img-circle elevation-3" style={{opacity: '.8'}} />
    <span className="brand-text font-weight-light">BRANDKILN</span>
  </a>
  {/* Sidebar */}
  <div className="sidebar">
    ...
    <div className="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div className="info">
        <a href="#" className="d-block">Redoy</a>
      </div>
    </div>
    {/* SidebarSearch Form */}
